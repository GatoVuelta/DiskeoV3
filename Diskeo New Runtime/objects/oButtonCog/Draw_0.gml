...
//Icon
draw_sprite_ext(s_LMC_i4, 0, x, y-x_threshold, 1, 1, 0, global.UI_element_focused, 1-init_alpha);
...
} else 
{
	...
	//Icon
	draw_sprite_ext(s_LMC_i4, 0, x, y-x_threshold, 1, 1, 0, global.UI_element_disabled, 1-init_alpha);
...
{
	scr_tooltip_left(x+40, y, 40, "Settings", border_alpha-init_alpha);
}