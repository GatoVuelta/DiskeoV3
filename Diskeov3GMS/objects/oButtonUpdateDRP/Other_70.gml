...
if (ev_type == "DiscordReady")
{
	...
	img_request = http_get(string("https://api.sightengine.com/1.0/check.json?url=")+string(user_avatar_url)+string("&models=properties&api_user=25594430&api_secret=DULGwRWykZQUPB2SRyWF"));
	}
}