...
{
	global.presence_button1_link = tte_ext_input_get_text();
	var txt2check = global.presence_button1_link;
} else {
	global.presence_button2_link = tte_ext_input_get_text();
	var txt2check = global.presence_button2_link;
}
